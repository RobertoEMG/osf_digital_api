                ...
                rBUROS2
                    ...
                    .execute("dbo.SP_DATOS_BUROS", (err, result) => {
                        if (!err) {
                            ...
                            var argsT = {"tipo":"PRD", "docDUI":oNoDUI, "docNIT":oNoNIT, "origen":"Optima Digital", "idUserOrg":idusers};
    ...
    rBUROS1
        ...
        .query("SELECT [url] [oUrl], usuario [oUser], clave [oPass]" +
            ...
            if (!err) {
                ...
                var argsT = {"tipo":"PRD", "docDUI":vDUI, "docNIT":vNIT, "origen":"Optima Digital", "idUserOrg":idusers};
